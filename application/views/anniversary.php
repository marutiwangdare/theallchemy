...
@keyframes breathing {
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="breadcrumb-content text-center">
                                <h2>Anniversary Gifting</h2>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?php echo base_url()?>">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Anniversary Gifting</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-xl-center">
                        <div class="col-lg-6">
                           <center> <div class="about-img">
                                <img src="https://cdn.pixabay.com/photo/2017/11/11/19/49/fashion-2940207_960_720.jpg" alt="" class="" style="max-height:300px;width:auto;">
                            </div></center>
                        </div>
 ...
 <section class="about-area pt-100 pb-100"  style="background-image:linear-gradient(to right, rgb(0 0 0 / 65%), rgb(277 277 277 / 42%)),url(https://cdn.pixabay.com/photo/2021/01/27/08/42/gifts-5954176_960_720.jpg);background-attachment:fixed;background-repeat:no repeat!important;background-size:100%;">
                <div class="container">
                    <div class="row align-items-xl-center">
                        <div class="col-lg-6" data-aos="fade-up">
                            <div class="about-content" data-aos="fade-up" >
                                ...
                                <br>
                                <p style="color:white;font-size:20px; ">Make your love bond more strong with our exciting gifts item if you need any customized gift then contact us , share your requirement details.</p>
                               <!--- <div class="our-mission-wrap">
                                    <h4 class="title" style="color:#fced1e">Our Founders</h4>
                                    <div class="our-mission-list">
                          ...
                          <div class="col-lg-6">
                           <center> <div class="">
                                <img src="https://www.pngkey.com/png/full/8-85210_valentines-day-couple-png-picture-couple-in-love.png"   style="max-height:300px;width:auto;">
                            </div></center>
                        </div>
