      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> Products</h1>
               </div>
            </div>
            <!-- END Page Title -->
            <!-- BEGIN Breadcrumb -->
               ...
               <div class="col-md-12">
                  <div class="box">
                     ...
                     <div class="box-content">
                        <form action="<?php if(!empty($product_select['productID'])){ echo base_url('admin/product-update');} else{ echo base_url('admin/product-insert');} ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label">Weight (grms) : </label>
                              <div class="col-sm-9 col-lg-10 controls">
                                 <input type="text" class="form-control" name="weight" value="<?php if(!empty($product_select['productID'])){ echo $product_select['weight']; }?>"  />
                              </div>
                           </div>
                           
                           <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label">Height (cm) : </label>
                              <div class="col-sm-9 col-lg-10 controls">
                                 <input type="text" class="form-control" name="height" value="<?php if(!empty($product_select['productID'])){ echo $product_select['height']; }?>"  />
                              </div>
                           </div>
                           
                           <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label">Width (cm) : </label>
                              <div class="col-sm-9 col-lg-10 controls">
                                 <input type="text" class="form-control" name="width" value="<?php if(!empty($product_select['productID'])){ echo $product_select['width']; }?>"  />
                              </div>
                           </div>
                           
                           <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label">Lenth (cm) : </label>
                              <div class="col-sm-9 col-lg-10 controls">
                                 <input type="text" class="form-control" name="lenth" value="<?php if(!empty($product_select['productID'])){ echo $product_select['lenth']; }?>"  />
                              </div>
                           </div>
                           
                           <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label">Search Keywords : </label>
                              <div class="col-sm-9 col-lg-10 controls">
                                 <input type="text" class="form-control" name="searchkeyword" value="<?php if(!empty($product_select['productID'])){ echo $product_select['searchkeyword']; }?>"  />
                              </div>
                           </div>
                           
                           <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label">Search Description : </label>
                              <div class="col-sm-9 col-lg-10 controls">
                                 <textarea class="form-control ckeditor" name="searchdescription" rows="3"><?php if(!empty($product_select['productID'])){ echo $product_select['product_description']; }?></textarea>
                              </div>
                           </div>
                           
                           <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label">Corporate Gift Item: </label>
                              <div class="col-sm-9 col-lg-10 controls">
                                 <select class="form-control" name="corporate_status"  data-placeholder="Corporate Gift Status" tabindex="1" required="">
                                    <option value="">Corporate Gift Status</option>
                              ...
                              <div class="col-sm-9 col-lg-10 controls">
                                 <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <div>
                                       ...
                                       <input type="file" class="file-input" name="images[]" /></span>
                           ...
                           {?>
                            <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label"></label>
                                ...
                                {
                                  $path=base_url('assets/images/products/').$value;
                                ?>
