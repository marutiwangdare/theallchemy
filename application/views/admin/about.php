      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> Food Pantry</h1>
               </div>
            </div>
            <!-- END Page Title -->
            <!-- BEGIN Breadcrumb -->
            <div id="breadcrumbs">
               <ul class="breadcrumb">
                  ...
                  <li class="active">Food Pantry</li>
               </ul>
            </div>
            <!-- END Breadcrumb -->
            <!-- BEGIN Main Content -->
            <div class="row">
               <div class="col-md-12">
                  <div class="box">
                     <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Food Pantry</h3>
                        <div class="box-tool">
                     ...
                     <div class="box-content">
                        <form action="<?php echo base_url('admin/about-update');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
