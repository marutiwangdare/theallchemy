      ...
      <div class="container" id="main-container">
         ...
         <div id="main-content">
            ...
            <div class="page-title">
               <div>
                  <h1><i class="fa fa-file-o"></i> View Today Deals</h1>
               </div>
            </div>
            <!-- END Page Title -->
            <!-- BEGIN Breadcrumb -->
            <div id="breadcrumbs">
               <ul class="breadcrumb">
                  ...
                  <li class="active">View Deal Items</li>
               </ul>
            </div>
            <!-- END Breadcrumb -->
            <div class="row">
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="box">
                     <div class="box-title">
                        <h3><i class="fa fa-table"></i> View Item</h3>
                        <div class="box-tool">
...
<td style="width:150px;"><?php echo $select_query['title'];?></td>
                                    ...
                                    <td><?php if(!empty($select_query['new_price'])){ echo 'Rs '.$select_query['new_price'];}else{echo "--";}?></td>
                                    <?php $data = urlencode(base64_encode($select_query['productID'])); ?>
                                    <td>
                                      &nbsp;&nbsp;<a class="btn btn-black show-tooltip text-white" title="Edit" href="#"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;<a class="btn btn-danger show-tooltip" title="Delete" href="<?php echo base_url('admin/deal-delete/').$data;?>"><i class="fa fa-trash-o"></i></a></td>
                                 </tr>
                                 <?php 
                                    $count++;
                                 } ?>
