...
<html xmlns="http://www.w3.org/1999/xhtml"
   ...
   <head>
      ...
      <style type="text/css" media="screen">
         /* Linked Styles */
         body { padding:0 !important; margin:0 !important; display:block !important; background:#ec1c4e47; -webkit-text-size-adjust:none }
   ...
   <body class="body" style="padding:0 !important; margin:0 !important; display:block !important; background:#ec1c4e47; -webkit-text-size-adjust:none">
                     ...
                     <td class="td" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; width:600px; min-width:600px; margin:0" width="600">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:60px;">
                           <tr>
                              <td>
                                 <!-- Head -->
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ec1c4e">
                                    <tr>
                                       <td>
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             <tr>
                                                <td class="img" style="background-color:#e9dfcf;border-radius: 0px 80px 600px 0px;border: 30px;font-size: 0pt;line-height: 0pt;text-align: left;" width="27"></td>
                                                <td>
                                                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                         <td class="img" style="font-size:0pt; line-height:0pt; text-align:left" height="3" bgcolor="#ec1c4e">&nbsp;</td>
                                                      </tr>
                                                   </table>
                                                   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                      <tr>
                                                ...
                                                <td class="img" style="background-color:#e9dfcf;border-radius: 0px 0px 80px 600px;border: 30px;font-size: 0pt;line-height: 0pt;text-align: left;" width="27"></td>
                                             </tr>
                                          </table>
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             <tr>
                                                <td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="3" bgcolor="#ec1c4e"></td>
                                 ...
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                    <tr>
                                       <td>
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <div class="h3-1-center" style="color:#000000; font-family:Georgia, serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center">Dear <?php echo $user_name;?>,Thanks for registration. Your account has been created.</div>
                                                   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                      <tr>
                                                         <td height="5" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
                                                      </tr>
                                                   </table>
                                                   <div class="h5-2-center" style="color:#000000; font-family:Arial, sans-serif; min-width:auto !important; font-size:16px; line-height:26px; text-align:center">
                                                      Kindly click the below button to verify your email: 
                                                   </div>
                                                   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                      <tr>
                                                      ...
                                                      <tr>
                                                         <td align="center">
                                                            <table width="210" border="0" cellspacing="0" cellpadding="0">
                                                               <tr>
                                                                  <td align="center" bgcolor="#ec1c4e" style="border-radius: 40px 0px;">
                                                                     <table border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                           <td class="img" style="font-size:0pt; line-height:0pt; text-align:left;border-radius: 70px 0px;" width="15">
                                                                              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                                                 <tr>
                                                                           ...
                                                                           <td bgcolor="#ec1c4e">
                                                                              <div class="text-btn" style="color:#ffffff; font-family:Arial, sans-serif; min-width:auto !important; font-size:16px; line-height:20px; text-align:center">
                                                                                 <a href="<?php echo $confirmation_link;?>" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none"><span class="link-white" style="color:#ffffff; text-decoration:none">Click Here</span></a>
                                                                              </div>
                                                                           </td>
                                          ...
                                          <div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="#" target="_blank"><img src="<?php echo base_url('assets/img/bg/b3.png');?>" border="0" width="600"  alt="" /></a></div>
                                 ...
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ec1c4e">
                                    <tr>
                                       <td>
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <div class="h3-1-center" style="color:#000000; font-family:Georgia, serif; min-width:auto !important; font-size:15px; color:#fff;line-height:26px; text-align:center">
                                                      &copy; <?php echo date('Y');?> The Allchemy. All Rights Reserved.
                                                   </div>
                                                   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                      <tr>
                                                         <td height="15" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             <tr>
                                                <td class="img" style="font-size:0pt; line-height:0pt; text-align:left;background-color: #e9dfcf;border-radius: 80px 600px 0px 0px;" width="27"></td>
                                                <td>
                                                   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                      <tr>
                                                         <td height="24" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
                                                ...
                                                <td class="img" style="font-size:0pt; line-height:0pt; text-align:left;background-color: #e9dfcf;border-radius:600px 80px 0px 0px;" width="27"></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
