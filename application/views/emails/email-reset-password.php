...
<html xmlns="http://www.w3.org/1999/xhtml"
   ...
   <head>
      ...
      <title>Seller Confirmation</title>
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <div class="h3-1-center" style="color:#000000; font-family:Georgia, serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center">Dear <?php echo $host_name;?>,</div>
                                                   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                      <tr>
                                                         <td height="5" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
                                                      </tr>
                                 ...
                                 <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#b18e53">
                                    <tr>
                                       <td>
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                             <tr>
                                                <td class="img" style="font-size:0pt; line-height:0pt; text-align:left;background-color: #e9dfcf;
    border-radius: 80px 600px 0px 0px;" width="27"></td>
                                                <td>
                                                   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                                                      <tr>
                                                         <td height="24" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
                                                ...
                                                <td class="img" style="font-size:0pt; line-height:0pt; text-align:left;background-color: #e9dfcf;
    border-radius:600px 80px 0px 0px;" width="27"></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
