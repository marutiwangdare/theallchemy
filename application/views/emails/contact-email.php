                 ...
                 <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#b18e53">
                  <tr>
                    <td>
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                        <td class="img" style="background-color:#ec1c4e;border-radius: 0px 80px 600px 0px;border: 30px;font-size: 0pt;line-height: 0pt;text-align: left;" width="27"></td>
                        <td>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                        ...
                        <td class="img" style="background-color:#ec1c4e;border-radius: 0px 0px 80px 600px;border: 30px;font-size: 0pt;line-height: 0pt;text-align: left;" width="27"></td>
                       </tr>
                     </table>
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                        ...
                        <td>
                          ...
                          <div class="h3-1-center" style="color:#000000; font-family:Georgia, serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center">Name : <?php echo $name;?><br>
                              Email : <?php echo $email;?><br>
                              Number : <?php echo $phone;?><br>
                              Subject : <?php echo $subject;?><br>
                              Message : <?php echo $message;?><br></div>
                           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                             <tr>
                              <td height="5" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
                             </tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#b18e53">
                    <tr>
                     <td>
                       ...
                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="img" style="font-size:0pt; line-height:0pt; text-align:left;background-color:  #5e081c;border-radius: 80px 600px 0px 0px;" width="27"></td>
                          <td>
                           <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">
                             <tr>
                              <td height="24" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td>
                          ...
                          <td class="img" style="font-size:0pt; line-height:0pt; text-align:left;background-color:  #5e081c;
